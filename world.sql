...
ALTER TABLE ONLY cityy
    ADD CONSTRAINT cityy_pkey PRIMARY KEY (id);

ALTER TABLE ONLY countryy
    ADD CONSTRAINT countryy_pkey PRIMARY KEY (code);

ALTER TABLE ONLY countryylanguage
    ADD CONSTRAINT countryylanguage_pkey PRIMARY KEY (countrycode, "language");
